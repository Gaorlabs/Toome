...
export const Login: React.FC<LoginProps> = ({ onAdminLogin, onClientLogin }) => {
  ...
  return (
    // Updated container: h-screen with overflow-y-auto enables scrolling on mobile despite body overflow-hidden
    <div className="h-screen w-full relative bg-[#F9FAFB] overflow-y-auto overflow-x-hidden">
      
      {/* Dynamic Background Elements - Fixed position to stay put while scrolling */}
      ...
      <div className="min-h-full flex flex-col items-center justify-center p-4 relative z-10 py-12">
        ...
        <div className="glass rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col md:flex-row relative z-10 animate-slide-up ring-1 ring-white/50 mb-8">
          ...
          >
              ...
              <div className="relative z-10">
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">Toome</h1>
                  <p className="text-odoo-light/90 text-base md:text-lg font-light leading-relaxed">
          ...
          {/* Form Section */}
          <div className="md:w-1/2 p-8 md:p-12 bg-white/60 relative flex flex-col justify-center min-h-[400px]">
        ...
        <div className="text-center w-full text-xs text-gray-400 font-medium flex flex-col items-center gap-1">
